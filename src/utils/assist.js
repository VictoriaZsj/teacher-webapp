// 获取当天前n天或后n天某一钟点的时间
export function getDate(hour,n=0) {
...
export function getVilidAttrWithEmpty(I){
  let part = {};
  Object.keys(I).forEach(function(item, index) {
    if(I[item] === null || I[item] === '' || I[item] === undefined){
...
//过滤掉null或者undefined或者空字符串的属性 不包括 0
export function getNotAttrWithEmpty(I){
    let part = {};
    Object.keys(I).forEach(function(item) {
        if(I[item]!==''&&I[item]!=null&&I[item]!=undefined ){
            part[item] = I[item]
        };
    });
    return part;
