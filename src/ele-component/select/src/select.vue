...
<script type="text/babel">
  ...
  import { addClass, removeClass, hasClass } from '../../../utils/ele/dom';
  import { addResizeListener, removeResizeListener } from '../../../utils/ele/resize-event';
  import { t } from '../../../../src/locale';
  import merge from '../../../utils/ele/merge';
  const sizeMap = {
    'large': 42,
    'small': 30,
    'mini': 22
  ...
  export default {
    ...
    methods: {
      ...
      getOption(value) {
        ...
        let label = typeof value === 'string' || typeof value === 'number'
          ? value : '';
        if(this.noregvalue != "" && this.noregvalue != null){
          label = this.noregvalue;
        }
        let newOption = {
          value: value,
          currentLabel: label
