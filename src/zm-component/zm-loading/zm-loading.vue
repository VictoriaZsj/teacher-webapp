<template>
 <div class="loading">
    <svg class="lds-spinner" :width="width"  :height="height"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" style="background: none; animation-play-state: running; animation-delay: 0s;"><g transform="rotate(0 50 50)" style="animation-play-state: running; animation-delay: 0s;">
        <rect x="47" y="24" rx="9.4" ry="4.8" width="6" height="12" :fill="color" style="animation-play-state: running; animation-delay: 0s;">
    ...
    <h4 class="desc" v-if="title">{{title}}</h4>
 </div>
</template>
