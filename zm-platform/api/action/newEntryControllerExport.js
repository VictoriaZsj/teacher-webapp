 ...
 *
 方法说明 转正管理导出
 *
 @method newEntryControllerExport
 *
 ...
 */
export default function newEntryControllerExport (options) {
    delete options["pageNo"];
    delete options["pageSize"];
    let url = "/api/teacher-web/api/newEntry/export"+encodeURI(window.toParams(options));
    console.log("url:",url);
