    ...
    <div class="full-time-container" v-if="permission">
        ...
        <div class="context-body">
            ...
            <div class="table-head">
                <span class="table-title">共{{table_data_total}}个离职老师</span>{{ keyWord }}
            ...
            <el-table :data="table_data" @selection-change="selectTable" style="width:100%">
                ...
                <el-table-column :formatter="transformDate" prop="hireTime" align="center" label="入职日期" width="200">
                </el-table-column>
                <el-table-column :formatter="transformDate" prop="leaveTime" align="center" label="离职日期" width="200">
                </el-table-column>
                <el-table-column prop="serviceTime" align="center" label="工龄">
                </el-table-column>
    ...
    methods: {
        ...
        getTableData() {
          this.tableLoading = true;
            this.$Fetch({
                url: '/api/farFarAway/getFarFarAwayTeaNames',
                method: 'post',
        ...
        // 导出excel
        exportExcel() {
            const url = `/api/teacher-web/api/farFarAway/export?keyWord=${this.search_data.keyWord}&positionType=${this.search_data.positionType}&teacherTimeType=${this.search_data.teacherTimeType}`;
