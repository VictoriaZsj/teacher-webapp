    ...
    <div class="full-time-container" v-if="permission">
        <el-form :inline="true" :model="search_data" class="search-form">
            ...
            <el-form-item label="是否入库">
                <el-select v-model="search_data.readyAt" placeholder="请选择">
                    <el-option label="全部" value=""></el-option>
        ...
        <div class="context-body">
            ...
            <el-table :data="table_data" @selection-change="selectTable" style="width:100%">
                ...
                <el-table-column align="center" label="代理类型" width="100">
...
export default {
    ...
    methods: {
        getTypeText(val){
          ...
          if(len > 0){
            for(let i = 0; i < len; i++){
              let itemVal = this.getAgentTypeByNumber(typeList[i]);
              if(itemVal){
                text = text + itemVal + ",";
              }
            }
