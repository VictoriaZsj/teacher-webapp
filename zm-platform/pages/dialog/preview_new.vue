    ...
    <div class="resume-back" @click="cancel">
        <div class="resume" @click.stop>
            <div class="resume-user-info">
                ...
                <div class="resume-user">
                    ...
                    <div class="other-info">
                        <template>
                            <p class="name">{{teaMsg.userName}}老师</p>
            ...
            <div class="resume-other-infos">
                ...
                <div class="resume-other-item" v-if="eduBackData && (eduBackData.awardRecordEnglishLevel || eduBackData.awardRecordToeflScore || eduBackData.awardRecordIeltsScore)">
                    <p class="other-item-title">
                        <span>专业证书</span>
                    </p>
                    <p class="other-item-content">
                        <template v-if="eduBackData.awardRecordEnglishLevel">
                            英语：{{eduBackData.awardRecordEnglishLevel}} <br />
                        </template>
                        <template v-if="eduBackData.awardRecordToeflScore">
                            托福：{{eduBackData.awardRecordToeflScore}}分<br />
                        </template>
                        <template v-if="eduBackData.awardRecordIeltsScore">
                            雅思：{{eduBackData.awardRecordIeltsScore}}分
                        </template>
                    </p>
                    <i class="other-info-pic jxjy"></i>
                </div>
...
export default {
    ...
    props: ['teaData', 'viewState', 'eduBackData'],
    created() {
    ...
    watch: {
        ...
        teaData: function(data) {
            ...
            //if(!!data.teachingSytle){
                this.teaMsg.teachingSytle = '严谨,活泼,平易近人'.split(',');
