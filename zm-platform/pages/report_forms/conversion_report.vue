  ...
  <div class="personal-report">
    ...
    <div class="search-warpper">
      <el-form :inline="true" :model="searchData">
        ...
        <el-form-item>
          <el-button class="search-btn" size="small" type="normal"  @click="handleExport" v-if="checkPermission('report-conversion-export')">导出excel</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      async getSourceData() {
        ...
        await this.$Fetch({
          url: '/api/report/fullTime/conversionsRatesReport',
          data: {
